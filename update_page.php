              ...
              <input type="hidden" value="add" name="add" />
                                <div class="row control-group">
                                    <div class="form-group col-xs-12 floating-label-form-group controls">
                                        ...
                                        <textarea rows="10" cols="40 " name="content"  class="form-control" placeholder="Message" id="message" required data-validation-required-message="Please enter a message."><?php $article = $this->getArticleById($_GET['update']); echo $article['content'] ?></textarea>
